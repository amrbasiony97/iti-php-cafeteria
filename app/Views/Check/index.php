            ...
            <div class="x_panel">
                <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php
                            foreach ($checks as $checkingOrder) :
                                if ($checkingOrder['status'] == "out for delivery") :
                            ?>
                                    <tr class="table-warning">
                                        <td><?php echo $checkingOrder['id'];  ?></td>
                                        <td><span class="badge badge-danger"><?php echo $checkingOrder['status'];  ?></span></td>
                                        <td>
                                            <form action="<?php route('Check/editCheckStatus') ?>" method="POST">
                                                <button type="submit" class="btn btn-success">To Done</button>
                                ...
                                ?>
                                    <tr class="table-secondary">
                                        ...
                                        <td>
                                            <form action="<?php route('Check/editCheckStatus') ?>" method="POST">
                                                <button type="submit" class="btn btn-warning">To Delivery</button>
                                                <input type="text" value="<?php echo $checkingOrder['id']; ?>" style="display:none" name="id">
                                            </form>
                                        </td>
                                    </tr>
...
<script>
    $(document).ready(function() {
        ...
        $('.delete-btn').on('click', function() {
            ...
            $('.modal-body .msg').html(`Are you sure you want to delete product: <strong>${name}</strong>?`);
            $('#delete-form').attr('action', `<?php echo route("product/destroy") ?>`);
